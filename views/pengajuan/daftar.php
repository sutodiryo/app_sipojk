...
/*                                            if ($p->tipe == 1) {
                                                ...
                                                echo "                  <div class='form-check'>
                                                                            <div class='checkbox'>
                                                                                <label for='checkbox1' class='form-check-label '>
                                                                                    <input type='checkbox' id='ceksurat' class='form-check-input'>Surat Pengajuan
                                                                                </label>
                                                                            </div>
                                                                        </div>";
                                            }
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-83px, 29px, 0px);">
                                                            <div class="dropdown-menu-content">
                                                                ...
                                                                <a class="dropdown-item" href="<?php echo base_url('pengajuan/statusproses/2'); echo $p->surat;?>"><i class='fa fa-rocket'></i> Diproses OJK</a>
                                                                <a class="dropdown-item" href="<?php echo base_url('pengajuan/statusproses/3'); echo $p->surat;?>"><i class='fa fa-envelope'></i> Surat Penegasan Diterbitkan</a>
                                                                <?php } ?>
