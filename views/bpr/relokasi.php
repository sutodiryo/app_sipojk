                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <?php echo form_open_multipart('bpr/relokasi_baru'); ?>
                                <div class="card-body card-block">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-7"><input required type="file" id="file-input" name="surat" class="form-control-file"></div>
                                    </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <button disabled class="btn btn-primary btn-lg"><i class="fa fa-rocket"></i> Kirim</button>
