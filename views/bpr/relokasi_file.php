            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php $this->session->set_userdata('referred_relokasi_file', current_url());?>
                        <?php echo $this->session->flashdata('notif');?>
                        
                        <div class="card">
                            <div class="card-header">
                                Form Pengajuan <strong>Izin Relokasi Kantor</strong>
                            </div>
                            ...
                            <?php foreach ($pengajuan as $p) {} ?>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?php echo base_url('bpr/kirim_relokasi/'); echo $p->surat?>" class="btn btn-primary btn-lg" ><i class="fa fa-rocket"></i> Kirim</a>
                                     <?php } else { ?>
                                    <code>*Untuk dapat mengirim data, semua dokumen harus dilengkapi terlebih dahulu</code><br>
                                    <button disabled type="submit" class="btn btn-primary btn-lg" ><i class="fa fa-rocket"></i> Kirim</button>
                                     <?php }?>
                                </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="modalAktasewa" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <?php echo form_open_multipart('bpr/relokasi_upload_file'); ?>
