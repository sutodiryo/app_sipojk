                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                Upload <strong>Surat Penegasan</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($pengajuan as $p) {
                                            ...
                                            <td style=\"font-size:60%;\"><center>
                                            ".form_open_multipart('pengajuan/penegasan_upload')."
                                            <input type='hidden' value='$p->nosurat' name='nosurat'>
                                            <input type=\"hidden\" name=\"tglpenegasan\" value=\" ".date('Y-m-d')."\">
                                            <input type='file' name='suratpenegasan'>
