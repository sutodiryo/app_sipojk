                                    ...
                                    <tbody>
                                        ...
                                        foreach ($pengajuan as $p) {
                                            ...
                                            echo "  <td style=\"font-size:80%;\">
                                                        <center>
                                                            <a href='".base_url('pengajuan/detail/')."$p->surat' class='btn btn-info btn-lg'><i class='fa fa-search-plus'></i> Lihat</a>
                                                        </center>
                                                    </td>";
                                            //LIHAT DOKUMEN
                                            ...
                                            */
                                            ...
                                            <!-- AKSI -->
                                            <td><center>
                                                <a class="btn btn-danger btn-lg" href="<?php echo base_url('pengajuan/hapus'); echo $p->surat;?>" onclick="return confirm('Hapus Pengajuan ini?')"><i class='fa fa-trash'></i> Hapus Pengajuan</a>
                                                </center>
                                            </td>
                                        </tr>
                                            <!-- AKSI -->
