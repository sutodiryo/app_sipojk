                                        ...
                                        foreach ($pengajuan as $p) {
                                            ...
                                            echo "<td><center>";
                                                ...
                                                if ($p->statuspengajuan == 0) {
                                                    ...
                                                    echo "<button class='btn btn-outline-warning type='button' data-toggle='dropdown'>Dokumen Sesuai</button>";
                                            ...
                                            { 
                                                ...
                                                { ?>
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="btn btn-lg dropdown-toggle btn-secondary" type="button" id="dropdownMenuButton1" data-toggle="dropdown" aria-expanded="false">
                                                            <i class="fa fa-check-square-o"></i>
                                                        </button>
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-83px, 29px, 0px);">
                                                            <div class="dropdown-menu-content">
                                                                <?php $penegasan = $this->db->query("SELECT suratpenegasan FROM pengajuan WHERE surat='$p->surat'")->row('suratpenegasan'); 
                                                                if ($this->session->userdata('log_status') == 3) {?>
                                                                    
                                                                <a class="dropdown-item" href="<?php echo base_url('pengajuan/proses_update/2/'); echo $p->surat;?>"><i class='fa fa-rocket'></i> Diproses OJK</a>

                                                                <?php
                                                                if (empty($penegasan))
                                                                { ?>
                                                                    <a class="dropdown-item" href="#" onclick="return alert('Surat Penegasan Belum Diupload')"><i class='fa fa-envelope'></i> Surat Penegasan Diterbitkan</a>
                                                                <?php
                                                                }
                                                                else                                                            
                                                                { ?>
                                                                    <a class="dropdown-item" href="<?php echo base_url('pengajuan/proses_update/3/'); echo $p->surat;?>"><i class='fa fa-envelope'></i> Surat Penegasan Diterbitkan</a>
                                                                <?php
                                                                } ?>
                                                                
                                                                <?php } ?>

                                                                <a class="dropdown-item" href="<?php echo base_url('pengajuan/hapus'); echo $p->surat;?>" onclick="return confirm('Hapus Pengajuan ini?')"><i class='fa fa-trash'></i> Hapus Pengajuan</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                { ?>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-83px, 29px, 0px);">
                                                            <div class="dropdown-menu-content">
                                                                <?php if ($this->session->userdata('log_status') == 3) {?>
                                                                <a class="dropdown-item" href="#"><i class='fa fa-refresh'></i> Dokumen Belum Lengkap</a>
                                                                <?php } ?>
                                                                <a class="dropdown-item"  href="<?php echo base_url('pengajuan/hapus'); echo $p->surat;?>" onclick="return confirm('Hapus Pengajuan ini?')" ><i class='fa fa-trash'></i> Hapus Pengajuan</a>
                                                            </div>
                                                        </div>
